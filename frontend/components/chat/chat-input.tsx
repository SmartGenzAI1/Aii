  ...
  return (
    <>
      ...
      <div className="border-input relative mt-3 flex min-h-[60px] w-full items-center justify-center rounded-xl border-2">
        ...
        {/* Mobile-optimized file button */}
        <>
          <IconCirclePlus
            className="absolute bottom-[12px] left-3 cursor-pointer p-1 hover:opacity-50 touch-manipulation"
            size={32}
        ...
        <TextareaAutosize
          ...
          value={userInput}
          minRows={1}
          maxRows={6} // Limit rows for better mobile UX
        ...
        {/* Mobile-optimized send/stop button */}
        <div className="absolute bottom-[14px] right-3 cursor-pointer hover:opacity-50 touch-manipulation">
          {isGenerating ? (
            <IconPlayerStopFilled
              className="hover:bg-background animate-pulse rounded bg-transparent p-2 md:p-1"
              onClick={handleStopMessage}
              size={window.innerWidth < 768 ? 36 : 30}
            />
          ) : (
            <IconSend
              className={cn(
                "bg-primary text-secondary rounded p-2 md:p-1",
